...
#define SLCAN_TX_Pin GPIO_PIN_9
#define SLCAN_TX_GPIO_Port GPIOA
#define SLCAN_RX_Pin GPIO_PIN_10
#define SLCAN_RX_GPIO_Port GPIOA
...
/* Turn signal stalk pins */
#define TURN_LEFT_Pin        GPIO_PIN_2
#define TURN_LEFT_GPIO_Port  GPIOA
#define TURN_RIGHT_Pin       GPIO_PIN_3
